...
// Indicators
#define LED_PIN        2   // Onboard LED (GPIO2) typical
#define LED_GREEN_PIN 25   // External green LED
#define LED_RED_PIN   26   // External red LED
#define BUZZER_PIN    15   // Passive buzzer to GPIO15 (with resistor)
...
// Registration mode flag (create empty file on microSD to allow unknown cards with success feedback)
